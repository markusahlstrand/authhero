...
const rows = [
  ...
  {
    feature: "Organizations (Multi-Tenant)",
    hero: "Free",
...
const Cell = ({ value }: { value: boolean | string }) => {
  if (value === true)
    return <Check className="h-4 w-4 text-success mx-auto" strokeWidth={1.5} />;
  if (value === false)
    return (
      <X
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border bg-secondary/50">
                ...
                <th className="py-3 px-4 font-medium text-center text-muted-foreground">
                  Auth0
                </th>
              </tr>
            </thead>
