...
- [Custom Domain Setup](/deployment/custom-domain-setup) - Configure custom domains for your customer tenants
...
- [Custom Domain Setup](/deployment/custom-domain-setup) - Configure `auth.coffeeshop.com` for customers
