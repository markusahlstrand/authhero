        ...
        },
        {
          ...
          items: [
            ...
            { text: "Adapters", link: "/concepts/adapters" },
            {
              ...
              link: "/concepts/deployment-targets/",
              collapsed: true,
              items: [
                { text: "Local Development", link: "/concepts/deployment-targets/local" },
                { text: "Cloudflare Workers", link: "/concepts/deployment-targets/cloudflare" },
                { text: "AWS", link: "/concepts/deployment-targets/aws" },
                { text: "Multi-Cloud", link: "/concepts/deployment-targets/multi-cloud" },
                { text: "Widget Assets", link: "/concepts/deployment-targets/widget-assets" },
              ],
            },
          ],
        },
