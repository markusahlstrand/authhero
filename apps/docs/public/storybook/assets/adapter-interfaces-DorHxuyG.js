function ht(i, t) {
  ...
  if (i != null && typeof Object.getOwnPropertySymbols == "function")
    for (var a = 0, r = Object.getOwnPropertySymbols(i); a < r.length; a++)
      t.indexOf(r[a]) < 0 &&
        Object.prototype.propertyIsEnumerable.call(i, r[a]) &&
        (n[r[a]] = i[r[a]]);
  return n;
}
function gt(i, t) {
  var n;
  return (
    ((n = i == null ? void 0 : i._def) === null || n === void 0
      ? void 0
      : n.typeName) === t
  );
}
function Q(i, t) {
  const n = i.ZodType.prototype[t];
  i.ZodType.prototype[t] = function (...r) {
    const a = n.apply(this, r);
    return ((a._def.openapi = this._def.openapi), a);
  };
}
function mt(i) {
  if (typeof i.ZodType.prototype.openapi < "u") return;
  ((i.ZodType.prototype.openapi = function (a, s) {
    var o, d, u, l, h, S;
    const D = typeof a == "string" ? s : a,
      G = D ?? {},
      { param: Pe } = G,
      pt = ht(G, ["param"]),
      He = Object.assign(
        ...
        typeof a == "string" ? { refId: a } : void 0,
      ),
      Ve = Object.assign(
        Object.assign(
          Object.assign(
            {},
            (d = this._def.openapi) === null || d === void 0
              ? void 0
              : d.metadata,
          ),
          pt,
      ...
      ze = new this.constructor(
        Object.assign(Object.assign({}, this._def), {
          openapi: Object.assign(
            Object.assign(
              {},
              Object.keys(He).length > 0 ? { _internal: He } : void 0,
            ),
            Object.keys(Ve).length > 0 ? { metadata: Ve } : void 0,
          ),
        }),
      );
    if (gt(this, "ZodObject")) {
      const _t = this.extend;
      ze.extend = function (...ft) {
        var ke, xe, Ie, Ne, we, Re;
        const je = _t.apply(this, ft);
        return (
          (je._def.openapi = {
            _internal: {
              extendedFrom:
                !(
                  (xe =
                    (ke = this._def.openapi) === null || ke === void 0
                      ? void 0
                      : ke._internal) === null || xe === void 0
                ) && xe.refId
                  ? {
                      refId:
                        (Ne =
                          (Ie = this._def.openapi) === null || Ie === void 0
                            ? void 0
                            : Ie._internal) === null || Ne === void 0
                          ? void 0
                          : Ne.refId,
                      schema: this,
                    }
                  : (we = this._def.openapi) === null || we === void 0
                    ? void 0
                    : we._internal.extendedFrom,
            },
            metadata:
              (Re = je._def.openapi) === null || Re === void 0
                ? void 0
                : Re.metadata,
          }),
          je
    ...
    Q(i, "transform"),
    Q(i, "refine"));
  const t = i.ZodObject.prototype.deepPartial;
  i.ZodObject.prototype.deepPartial = function () {
    ...
    return (
      Object.entries(o).forEach(([d, u]) => {
        var l, h;
        u._def.openapi =
          (h = (l = a[d]) === null || l === void 0 ? void 0 : l._def) ===
            null || h === void 0
            ? void 0
            : h.openapi;
      }),
  ...
  const n = i.ZodObject.prototype.pick;
  i.ZodObject.prototype.pick = function (...a) {
    const s = n.apply(this, a);
    return ((s._def.openapi = void 0), s);
  };
  const r = i.ZodObject.prototype.omit;
  i.ZodObject.prototype.omit = function (...a) {
...
(function (i) {
  ...
  ((i.assertNever = n),
    ...
    (i.getValidEnumValues = (a) => {
      const s = i.objectKeys(a).filter((d) => typeof a[a[d]] != "number"),
        o = {};
      for (const d of s) o[d] = a[d];
      return i.objectValues(o);
    }),
    (i.objectValues = (a) =>
      i.objectKeys(a).map(function (s) {
        return a[s];
      })),
    (i.objectKeys =
  ...
  ((i.joinValues = r),
    (i.jsonStringifyReplacer = (a, s) =>
      typeof s == "bigint" ? s.toString() : s));
})(b || (b = {}));
var De;
(function (i) {
  i.mergeShapes = (t, n) => ({ ...t, ...n });
})(De || (De = {}));
const _ = b.arrayToEnum([
    "string",
    "nan",
    "number",
    "integer",
  ...
  yt = (i) => JSON.stringify(i, null, 2).replace(/"([^"]+)":/g, "$1:");
class C extends Error {
        ...
        for (const o of s.issues)
          if (o.code === "invalid_union") o.unionErrors.map(a);
            ...
            for (; u < o.path.length; ) {
              const l = o.path[u];
              (u === o.path.length - 1
                ? ((d[l] = d[l] || { _errors: [] }), d[l]._errors.push(n(o)))
                : (d[l] = d[l] || { _errors: [] }),
                (d = d[l]),
                u++);
            }
  ...
  static assert(t) {
    if (!(t instanceof C)) throw new Error(`Not a ZodError: ${t}`);
  }
  toString() {
    return this.message;
  }
  ...
  flatten(t = (n) => n.message) {
    ...
    for (const a of this.issues)
      a.path.length > 0
        ? ((n[a.path[0]] = n[a.path[0]] || []), n[a.path[0]].push(t(a)))
        : r.push(t(a));
...
const X = (i, t) => {
  ...
  switch (i.code) {
    case c.invalid_type:
      i.received === _.undefined
        ? (n = "Required")
        : (n = `Expected ${i.expected}, received ${i.received}`);
      break;
    case c.invalid_literal:
      n = `Invalid literal value, expected ${JSON.stringify(i.expected, b.jsonStringifyReplacer)}`;
      break;
    case c.unrecognized_keys:
      n = `Unrecognized key(s) in object: ${b.joinValues(i.keys, ", ")}`;
      break;
    case c.invalid_union:
      n = "Invalid input";
      break;
    case c.invalid_union_discriminator:
      n = `Invalid discriminator value. Expected ${b.joinValues(i.options)}`;
      break;
    case c.invalid_enum_value:
      n = `Invalid enum value. Expected ${b.joinValues(i.options)}, received '${i.received}'`;
      break;
    ...
    case c.invalid_string:
      typeof i.validation == "object"
        ? "includes" in i.validation
          ? ((n = `Invalid input: must include "${i.validation.includes}"`),
            typeof i.validation.position == "number" &&
              (n = `${n} at one or more positions greater than or equal to ${i.validation.position}`))
          : "startsWith" in i.validation
            ? (n = `Invalid input: must start with "${i.validation.startsWith}"`)
            : "endsWith" in i.validation
              ? (n = `Invalid input: must end with "${i.validation.endsWith}"`)
              : b.assertNever(i.validation)
        : i.validation !== "regex"
          ? (n = `Invalid ${i.validation}`)
          : (n = "Invalid");
      break;
    case c.too_small:
      i.type === "array"
        ? (n = `Array must contain ${i.exact ? "exactly" : i.inclusive ? "at least" : "more than"} ${i.minimum} element(s)`)
        : i.type === "string"
          ? (n = `String must contain ${i.exact ? "exactly" : i.inclusive ? "at least" : "over"} ${i.minimum} character(s)`)
          : i.type === "number"
            ? (n = `Number must be ${i.exact ? "exactly equal to " : i.inclusive ? "greater than or equal to " : "greater than "}${i.minimum}`)
            : i.type === "date"
              ? (n = `Date must be ${i.exact ? "exactly equal to " : i.inclusive ? "greater than or equal to " : "greater than "}${new Date(Number(i.minimum))}`)
              : (n = "Invalid input");
      break;
    case c.too_big:
      i.type === "array"
        ? (n = `Array must contain ${i.exact ? "exactly" : i.inclusive ? "at most" : "less than"} ${i.maximum} element(s)`)
        : i.type === "string"
          ? (n = `String must contain ${i.exact ? "exactly" : i.inclusive ? "at most" : "under"} ${i.maximum} character(s)`)
          : i.type === "number"
            ? (n = `Number must be ${i.exact ? "exactly" : i.inclusive ? "less than or equal to" : "less than"} ${i.maximum}`)
            : i.type === "bigint"
              ? (n = `BigInt must be ${i.exact ? "exactly" : i.inclusive ? "less than or equal to" : "less than"} ${i.maximum}`)
              : i.type === "date"
                ? (n = `Date must be ${i.exact ? "exactly" : i.inclusive ? "smaller than or equal to" : "smaller than"} ${new Date(Number(i.maximum))}`)
                : (n = "Invalid input");
      break;
    case c.custom:
      n = "Invalid input";
    ...
    case c.not_finite:
      ...
      break;
    default:
      ((n = t.defaultError), b.assertNever(i));
  }
  return { message: n };
};
let We = X;
...
const ye = (i) => {
    const { data: t, path: n, errorMaps: r, issueData: a } = i,
      s = [...n, ...(a.path || [])],
      o = { ...a, path: s };
    ...
    const u = r
      ...
      .slice()
      .reverse();
    for (const l of u) d = l(o, { data: t, defaultError: d }).message;
    return { ...a, path: s, message: d };
  },
  bt = [];
function p(i, t) {
  const n = me(),
...
class T {
  ...
  static mergeObjectSync(t, n) {
    ...
    for (const a of n) {
      ...
      if (s.status === "aborted" || o.status === "aborted") return m;
...
const m = Object.freeze({ status: "aborted" }),
  W = (i) => ({ status: "dirty", value: i }),
  A = (i) => ({ status: "valid", value: i }),
  Ue = (i) => i.status === "aborted",
  Fe = (i) => i.status === "dirty",
  H = (i) => i.status === "valid",
  ne = (i) => typeof Promise < "u" && i instanceof Promise;
function ve(i, t, n, r) {
...
var f;
(function (i) {
  ((i.errToObj = (t) => (typeof t == "string" ? { message: t } : t || {})),
    (i.toString = (t) =>
        ...
        errorMap: (o, d) => {
          ...
          return o.code === "invalid_enum_value"
            ...
            : typeof d.data > "u"
              ? {
                  message:
                    (u = h ?? r) !== null && u !== void 0 ? u : d.defaultError,
                }
              : o.code !== "invalid_type"
...
class v {
  ...
  _parseSync(t) {
    ...
    if (ne(n)) throw new Error("Synchronous parse encountered promise.");
    return n;
  }
  _parseAsync(t) {
    const n = this._parse(t);
  ...
  "~validate"(t) {
    ...
    if (!this["~standard"].async)
      try {
        ...
        return H(s) ? { value: s.value } : { issues: a.common.issues };
      } catch (s) {
        (!(
          (r =
    ...
    return this._parseAsync({ data: t, path: [], parent: a }).then((s) =>
      H(s) ? { value: s.value } : { issues: a.common.issues },
    );
  }
  ...
  async safeParseAsync(t, n) {
    const r = {
      ...
      s = await (ne(a) ? a : Promise.resolve(a));
    return Ge(r, s);
  }
  refine(t, n) {
    const r = (a) =>
    ...
    return this._refinement((a, s) => {
      const o = t(a),
        d = () => s.addIssue({ code: c.custom, ...r(a) });
  ...
  or(t) {
    return se.create([this, t], this._def);
  }
  and(t) {
  ...
  brand() {
    return new Ze({ typeName: g.ZodBranded, type: this, ...y(this._def) });
  }
  catch(t) {
    const n = typeof t == "function" ? t : () => t;
    return new _e({
...
const Et = /^c[^\s-]{8,}$/i,
  St = /^[0-9a-z]+$/,
  Tt = /^[0-9A-HJKMNP-TV-Z]{26}$/i,
  At =
    /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i,
  Ct = /^[a-z0-9_-]{21}$/i,
  Ot = /^[A-Za-z0-9-_]+\.[A-Za-z0-9-_]+\.[A-Za-z0-9-_]*$/,
  kt =
    /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/,
  xt =
    /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i,
  It = "^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$";
let Le;
const Nt =
...
function qe(i) {
  ...
  i.precision
    ? (t = `${t}\\.\\d{${i.precision}}`)
    : i.precision == null && (t = `${t}(\\.\\d+)?`);
  const n = i.precision ? "+" : "?";
  return `([01]\\d|2[0-3]):[0-5]\\d(:${t})${n}`;
}
function Ft(i) {
  return new RegExp(`^${qe(i)}$`);
}
function Ye(i) {
  let t = `${Xe}T${qe(i)}`;
  const n = [];
...
class O extends v {
  ...
  regex(t, n) {
    return this._addCheck({ kind: "regex", regex: t, ...f.errToObj(n) });
  }
  includes(t, n) {
  ...
  startsWith(t, n) {
    return this._addCheck({ kind: "startsWith", value: t, ...f.errToObj(n) });
  }
  endsWith(t, n) {
    return this._addCheck({ kind: "endsWith", value: t, ...f.errToObj(n) });
  }
  min(t, n) {
    return this._addCheck({ kind: "min", value: t, ...f.errToObj(n) });
  }
  max(t, n) {
    return this._addCheck({ kind: "max", value: t, ...f.errToObj(n) });
  }
  length(t, n) {
    return this._addCheck({ kind: "length", value: t, ...f.errToObj(n) });
  }
  nonempty(t) {
...
O.create = (i) => {
  ...
  return new O({
    ...
    coerce:
      (t = i == null ? void 0 : i.coerce) !== null && t !== void 0 ? t : !1,
    ...y(i),
  });
};
function Ht(i, t) {
  const n = (i.toString().split(".")[1] || "").length,
    r = (t.toString().split(".")[1] || "").length,
    a = n > r ? n : r,
    s = parseInt(i.toFixed(a).replace(".", "")),
...
class U extends v {
            ...
            : s.kind === "multipleOf"
              ...
              : s.kind === "finite"
                ? Number.isFinite(t.data) ||
                  ((r = this._getOrReturnCtx(t, r)),
                  p(r, { code: c.not_finite, message: s.message }),
                  a.dirty())
                : b.assertNever(s);
  ...
  setLimit(t, n, r, a) {
    return new U({
      ...
      checks: [
        ...this._def.checks,
        { kind: t, value: n, inclusive: r, message: f.toString(a) },
      ],
    });
  }
  _addCheck(t) {
  ...
  get isInt() {
    return !!this._def.checks.find(
      (t) =>
        t.kind === "int" || (t.kind === "multipleOf" && b.isInteger(t.value)),
    );
  }
  get isFinite() {
    let t = null,
...
class F extends v {
  ...
  _parse(t) {
    ...
    if (this._getType(t) !== _.bigint) return this._getInvalidInput(t);
    let r;
    const a = new T();
    for (const s of this._def.checks)
      s.kind === "min"
  ...
  _addCheck(t) {
    return new F({ ...this._def, checks: [...this._def.checks, t] });
  }
  positive(t) {
    return this._addCheck({
      kind: "min",
...
class ie extends v {
  _parse(t) {
    if (
      (this._def.coerce && (t.data = !!t.data), this._getType(t) !== _.boolean)
    ) {
...
class V extends v {
  _parse(t) {
    ...
    if (isNaN(t.data.getTime())) {
      const s = this._getOrReturnCtx(t);
      return (p(s, { code: c.invalid_date }), m);
    }
    const r = new T();
    let a;
    for (const s of this._def.checks)
  ...
  _addCheck(t) {
    return new V({ ...this._def, checks: [...this._def.checks, t] });
  }
  min(t, n) {
    return this._addCheck({
      kind: "min",
...
be.create = (i) => new be({ typeName: g.ZodSymbol, ...y(i) });
class re extends v {
  _parse(t) {
...
re.create = (i) => new re({ typeName: g.ZodUndefined, ...y(i) });
class ae extends v {
  _parse(t) {
...
ae.create = (i) => new ae({ typeName: g.ZodNull, ...y(i) });
class q extends v {
  constructor() {
...
q.create = (i) => new q({ typeName: g.ZodAny, ...y(i) });
class P extends v {
  constructor() {
...
P.create = (i) => new P({ typeName: g.ZodUnknown, ...y(i) });
class L extends v {
  _parse(t) {
    const n = this._getOrReturnCtx(t);
    return (
      p(n, { code: c.invalid_type, expected: _.never, received: n.parsedType }),
      m
    );
  }
}
L.create = (i) => new L({ typeName: g.ZodNever, ...y(i) });
class Ee extends v {
  _parse(t) {
    if (this._getType(t) !== _.undefined) {
      const r = this._getOrReturnCtx(t);
...
Ee.create = (i) => new Ee({ typeName: g.ZodVoid, ...y(i) });
class k extends v {
  _parse(t) {
    ...
    if (a.exactLength !== null) {
      const o = n.data.length > a.exactLength.value,
        d = n.data.length < a.exactLength.value;
      (o || d) &&
        (p(n, {
    ...
    if (
      ...
      return Promise.all(
        [...n.data].map((o, d) => a.type._parseAsync(new N(n, o, n.path, d))),
      ).then((o) => T.mergeArray(r, o));
    const s = [...n.data].map((o, d) =>
      a.type._parseSync(new N(n, o, n.path, d)),
    );
...
function $(i) {
  if (i instanceof E) {
    ...
    return new E({ ...i._def, shape: () => t });
  } else
    return i instanceof k
      ? new k({ ...i._def, type: $(i.element) })
      : i instanceof I
        ? I.create($(i.unwrap()))
        : i instanceof Z
          ? Z.create($(i.unwrap()))
          : i instanceof w
            ? w.create(i.items.map((t) => $(t)))
            : i;
}
class E extends v {
  constructor() {
  ...
  _parse(t) {
    ...
    if (!(this._def.catchall instanceof L && this._def.unknownKeys === "strip"))
      for (const l in a.data) o.includes(l) || d.push(l);
    const u = [];
    for (const l of o) {
      const h = s[l],
        S = a.data[l];
      u.push({
        ...
        value: h._parse(new N(a, S, a.path, l)),
    ...
    if (this._def.catchall instanceof L) {
      ...
      if (l === "passthrough")
        ...
        d.length > 0 &&
          (p(a, { code: c.unrecognized_keys, keys: d }), r.dirty());
      else if (l !== "strip")
      ...
      for (const h of d) {
        ...
        u.push({
          key: { status: "valid", value: h },
          value: l._parse(new N(a, S, a.path, h)),
      ...
      ? Promise.resolve()
          .then(async () => {
            ...
            for (const h of u) {
              const S = await h.key,
                D = await h.value;
              l.push({ key: S, value: D, alwaysSet: h.alwaysSet });
            }
            return l;
          })
          .then((l) => T.mergeObjectSync(r, l))
      : T.mergeObjectSync(r, u);
  }
  get shape() {
                ...
                const u =
                  (o =
                    (s = (a = this._def).errorMap) === null || s === void 0
                      ? void 0
                      : s.call(a, n, r).message) !== null && o !== void 0
                    ? o
                    : r.defaultError;
                return n.code === "unrecognized_keys"
                  ? {
                      message:
                        (d = f.errToObj(t).message) !== null && d !== void 0
                          ? d
                          : u,
                    }
                  : { message: u };
  ...
  pick(t) {
    const n = {};
    return (
      b.objectKeys(t).forEach((r) => {
        t[r] && this.shape[r] && (n[r] = this.shape[r]);
      }),
      new E({ ...this._def, shape: () => n })
    );
  }
  omit(t) {
    const n = {};
    return (
      b.objectKeys(this.shape).forEach((r) => {
    ...
    return (
      b.objectKeys(this.shape).forEach((r) => {
        if (t && !t[r]) n[r] = this.shape[r];
          ...
          let s = this.shape[r];
          for (; s instanceof I; ) s = s._def.innerType;
          n[r] = s;
        }
      }),
      new E({ ...this._def, shape: () => n })
...
class se extends v {
  _parse(t) {
    ...
    function a(s) {
      ...
      const o = s.map((d) => new C(d.ctx.common.issues));
      return (p(n, { code: c.invalid_union, unionErrors: o }), m);
    }
    if (n.common.async)
      return Promise.all(
        r.map(async (s) => {
      ...
      ).then(a);
    {
      ...
      for (const u of r) {
        const l = { ...n, common: { ...n.common, issues: [] }, parent: null },
          h = u._parseSync({ data: n.data, path: n.path, parent: l });
        if (h.status === "valid") return h;
        (h.status === "dirty" && !s && (s = { result: h, ctx: l }),
          l.common.issues.length && o.push(l.common.issues));
      }
      if (s) return (n.common.issues.push(...s.ctx.common.issues), s.result);
      const d = o.map((u) => new C(u));
      return (p(n, { code: c.invalid_union, unionErrors: d }), m);
    }
  }
  get options() {
...
se.create = (i, t) => new se({ options: i, typeName: g.ZodUnion, ...y(t) });
const R = (i) =>
  i instanceof ce
    ? R(i.schema)
    : i instanceof x
              ...
              : i instanceof re
                ...
                : i instanceof ae
                  ...
                  : i instanceof I
                    ...
                    : i instanceof Z
                      ? [null, ...R(i.unwrap())]
                      : i instanceof Ze || i instanceof fe
                        ? R(i.unwrap())
                        : i instanceof _e
                          ? R(i._def.innerType)
                          : [];
  ...
  static create(t, n, r) {
    ...
    for (const s of n) {
      ...
      for (const d of o) {
        if (a.has(d))
          throw new Error(
            `Discriminator property ${String(t)} has duplicate value ${String(d)}`,
          );
        a.set(d, s);
      }
    }
...
function Me(i, t) {
  const n = j(i),
    r = j(t);
  if (i === t) return { valid: !0, data: i };
  if (n === _.object && r === _.object) {
    const a = b.objectKeys(t),
      s = b.objectKeys(i).filter((d) => a.indexOf(d) !== -1),
      o = { ...i, ...t };
    for (const d of s) {
      const u = Me(i[d], t[d]);
    ...
    if (i.length !== t.length) return { valid: !1 };
    const a = [];
...
class oe extends v {
  _parse(t) {
    const { status: n, ctx: r } = this._processInputParams(t),
      a = (s, o) => {
        if (Ue(s) || Ue(o)) return m;
        const d = Me(s.value, o.value);
        return d.valid
          ? ((Fe(s) || Fe(o)) && n.dirty(), { status: n.value, value: d.data })
          : (p(r, { code: c.invalid_intersection_types }), m);
      };
...
oe.create = (i, t, n) =>
  new oe({ left: i, right: t, typeName: g.ZodIntersection, ...y(n) });
class w extends v {
  _parse(t) {
    const { status: n, ctx: r } = this._processInputParams(t);
    ...
    const s = [...r.data]
      .map((o, d) => {
        ...
        return u ? u._parse(new N(r, o, r.path, d)) : null;
      })
      .filter((o) => !!o);
    return r.common.async
      ? Promise.all(s).then((o) => T.mergeArray(n, o))
      : T.mergeArray(n, s);
  }
  get items() {
...
w.create = (i, t) => {
  ...
  return new w({ items: i, typeName: g.ZodTuple, rest: null, ...y(t) });
};
class de extends v {
  get keySchema() {
  ...
  _parse(t) {
    ...
    for (const d in r.data)
      a.push({
        key: s._parse(new N(r, d, r.path, d)),
        value: o._parse(new N(r, r.data[d], r.path, d)),
        alwaysSet: d in r.data,
      });
    return r.common.async ? T.mergeObjectAsync(n, a) : T.mergeObjectSync(n, a);
  }
  get element() {
    return this._def.valueType;
  }
  static create(t, n, r) {
    return n instanceof v
      ? new de({ keyType: t, valueType: n, typeName: g.ZodRecord, ...y(r) })
      : new de({
          keyType: O.create(),
          valueType: t,
...
class Se extends v {
  ...
  _parse(t) {
    ...
    if (r.parsedType !== _.map)
      return (
        p(r, { code: c.invalid_type, expected: _.map, received: r.parsedType }),
        m
      );
    const a = this._def.keyType,
      s = this._def.valueType,
      o = [...r.data.entries()].map(([d, u], l) => ({
        key: a._parse(new N(r, d, r.path, [l, "key"])),
        value: s._parse(new N(r, u, r.path, [l, "value"])),
      }));
    if (r.common.async) {
      const d = new Map();
      return Promise.resolve().then(async () => {
        for (const u of o) {
          const l = await u.key,
            h = await u.value;
          if (l.status === "aborted" || h.status === "aborted") return m;
          ((l.status === "dirty" || h.status === "dirty") && n.dirty(),
            d.set(l.value, h.value));
        }
...
Se.create = (i, t, n) =>
  new Se({ valueType: t, keyType: i, typeName: g.ZodMap, ...y(n) });
class z extends v {
  _parse(t) {
    const { status: n, ctx: r } = this._processInputParams(t);
    if (r.parsedType !== _.set)
      return (
        p(r, { code: c.invalid_type, expected: _.set, received: r.parsedType }),
        m
      );
    const a = this._def;
    (a.minSize !== null &&
    ...
    function o(u) {
      const l = new Set();
      for (const h of u) {
        if (h.status === "aborted") return m;
        (h.status === "dirty" && n.dirty(), l.add(h.value));
      }
      return { status: n.value, value: l };
    }
    const d = [...r.data.values()].map((u, l) =>
      s._parse(new N(r, u, r.path, l)),
    );
...
class K extends v {
  ...
  _parse(t) {
    ...
    if (this._def.returns instanceof Y) {
      ...
      return A(async function (...u) {
        const l = new C([]),
          h = await d._def.args.parseAsync(u, s).catch((G) => {
            throw (l.addIssue(r(u, G)), l);
          }),
          S = await Reflect.apply(o, this, h);
        return await d._def.returns._def.type.parseAsync(S, s).catch((G) => {
          throw (l.addIssue(a(S, G)), l);
        });
      });
    } else {
      const d = this;
      return A(function (...u) {
        const l = d._def.args.safeParse(u, s);
        if (!l.success) throw new C([r(u, l.error)]);
        const h = Reflect.apply(o, this, l.data),
          S = d._def.returns.safeParse(h, s);
        if (!S.success) throw new C([a(h, S.error)]);
        return S.data;
      });
    }
  }
  ...
  args(...t) {
    return new K({ ...this._def, args: w.create(t).rest(P.create()) });
  }
  returns(t) {
    return new K({ ...this._def, returns: t });
  }
  implement(t) {
    return this.parse(t);
  }
...
ce.create = (i, t) => new ce({ getter: i, typeName: g.ZodLazy, ...y(t) });
class le extends v {
  _parse(t) {
...
le.create = (i, t) => new le({ value: i, typeName: g.ZodLiteral, ...y(t) });
function Je(i, t) {
  return new M({ values: i, typeName: g.ZodEnum, ...y(t) });
}
class M extends v {
  constructor() {
  ...
  _parse(t) {
    ...
    if (
      (ve(this, ee) || Ke(this, ee, new Set(this._def.values)),
      !ve(this, ee).has(t.data))
    ) {
      const n = this._getOrReturnCtx(t),
        r = this._def.values;
      return (
        p(n, { received: n.data, code: c.invalid_enum_value, options: r }),
        m
      );
    }
    return A(t.data);
...
class ue extends v {
  ...
  _parse(t) {
    ...
    if (
      (ve(this, te) ||
        Ke(this, te, new Set(b.getValidEnumValues(this._def.values))),
      !ve(this, te).has(t.data))
    ) {
      const a = b.objectValues(n);
      return (
        p(r, { received: r.data, code: c.invalid_enum_value, options: a }),
        m
      );
    }
    return A(t.data);
...
te = new WeakMap();
ue.create = (i, t) => new ue({ values: i, typeName: g.ZodNativeEnum, ...y(t) });
class Y extends v {
  unwrap() {
    return this._def.type;
  }
...
Y.create = (i, t) => new Y({ type: i, typeName: g.ZodPromise, ...y(t) });
class x extends v {
  innerType() {
        ...
        return this._def.schema
          ...
          .then((d) =>
            d.status === "aborted"
              ? m
              : (d.status === "dirty" && n.dirty(),
                o(d.value).then(() => ({ status: n.value, value: d.value }))),
          );
    }
    if (a.type === "transform")
      if (r.common.async === !1) {
        ...
        return this._def.schema
          ...
          .then((o) =>
            H(o)
              ? Promise.resolve(a.transform(o.value, s)).then((d) => ({
                  status: n.value,
                  value: d,
                }))
              : o,
...
x.create = (i, t, n) =>
  new x({ schema: i, typeName: g.ZodEffects, effect: t, ...y(n) });
x.createWithPreprocess = (i, t, n) =>
  new x({
    schema: t,
...
I.create = (i, t) => new I({ innerType: i, typeName: g.ZodOptional, ...y(t) });
class Z extends v {
  _parse(t) {
...
Z.create = (i, t) => new Z({ innerType: i, typeName: g.ZodNullable, ...y(t) });
class pe extends v {
  _parse(t) {
    const { ctx: n } = this._processInputParams(t);
    let r = n.data;
    return (
      n.parsedType === _.undefined && (r = this._def.defaultValue()),
...
class Te extends v {
  _parse(t) {
    if (this._getType(t) !== _.nan) {
      const r = this._getOrReturnCtx(t);
      return (
        p(r, { code: c.invalid_type, expected: _.nan, received: r.parsedType }),
        m
      );
    }
    return { status: "valid", value: t.data };
...
Te.create = (i) => new Te({ typeName: g.ZodNaN, ...y(i) });
...
class he extends v {
  ...
  static create(t, n) {
    return new he({ in: t, out: n, typeName: g.ZodPipeline });
  }
}
class fe extends v {
  _parse(t) {
    const n = this._def.innerType._parse(t),
      r = (a) => (H(a) && (a.value = Object.freeze(a.value)), a);
    return ne(n) ? n.then((a) => r(a)) : r(n);
  }
  unwrap() {
    return this._def.innerType;
  }
...
fe.create = (i, t) =>
  new fe({ innerType: i, typeName: g.ZodReadonly, ...y(t) });
function Be(i, t) {
  const n =
    typeof i == "function" ? i(t) : typeof i == "string" ? { message: i } : i;
        ...
        if (d instanceof Promise)
          return d.then((u) => {
            ...
            if (!u) {
              const S = Be(t, r),
                D =
                  (h = (l = S.fatal) !== null && l !== void 0 ? l : n) !==
                    null && h !== void 0
                    ? h
                    : !0;
              a.addIssue({ code: "custom", ...S, fatal: D });
            }
          });
        if (!d) {
          const u = Be(t, r),
            l =
              (o = (s = u.fatal) !== null && s !== void 0 ? s : n) !== null &&
              o !== void 0
                ? o
                : !0;
...
const Gt = (i, t = { message: `Input not instance of ${i.name}` }) =>
    Qe((n) => n instanceof i, t),
  et = O.create,
  tt = U.create,
  Bt = Te.create,
  $t = F.create,
  ...
  yn = I.create,
  vn = Z.create,
  bn = x.createWithPreprocess,
  En = he.create,
  Sn = () => et().optional(),
  Tn = () => tt().optional(),
  An = () => nt().optional(),
  Cn = {
    string: (i) => O.create({ ...i, coerce: !0 }),
    number: (i) => U.create({ ...i, coerce: !0 }),
    boolean: (i) => ie.create({ ...i, coerce: !0 }),
    bigint: (i) => F.create({ ...i, coerce: !0 }),
    date: (i) => V.create({ ...i, coerce: !0 }),
  },
  On = m;
var e = Object.freeze({
  __proto__: null,
...
mt(e);
e.object({ start: e.number(), limit: e.number(), length: e.number() });
const J = e.object({ created_at: e.string(), updated_at: e.string() }),
  kn = e
    .object({
  ...
  xn = e.object({
    ...
    profileData: kn.optional(),
  }),
  it = e.object({
    email: e
      .string()
      .optional()
      .transform((i) => i && i.toLowerCase()),
    username: e.string().optional(),
    phone_number: e.string().optional(),
    given_name: e.string().optional(),
    family_name: e.string().optional(),
...
e.object({
  ...
  identities: e.array(xn).optional(),
});
it.extend({
...
let wn = (i = 21) => {
  let t = "",
    n = crypto.getRandomValues(new Uint8Array(i));
  for (; i--; ) t += Nn[n[i] & 63];
  return t;
};
const Rn = e.object({
    client_id: e.string().openapi({ description: "ID of this client." }),
    ...
    session_transfer: e
      ...
      .default({})
      .optional()
      .openapi({ description: "Native to Web SSO Configuration" }),
    oidc_logout: e
      .record(e.any())
      .default({})
      .optional()
      .openapi({ description: "Configuration for OIDC backchannel logout" }),
    ...
    organization_require_behavior: e
    ...
    client_authentication_methods: e
      .record(e.any())
      .default({})
      .optional()
      .openapi({ description: "Defines client authentication methods." }),
  ...
  Ln = e.object({
    ...
    scope: e
      .array(e.string())
      .optional()
      .openapi({ description: "Scopes allowed for this client grant." }),
    organization_usage: e
      .enum(["deny", "allow", "require"])
      .optional()
      .openapi({
  ...
  Dn = e.object({
    id: e.string().openapi({ description: "ID of the client grant." }),
    ...Ln.shape,
    created_at: e.string().optional(),
    updated_at: e.string().optional(),
  });
e.array(Dn);
const ge = e.object({ x: e.number(), y: e.number() });
var rt = ((i) => (
    (i.RICH_TEXT = "RICH_TEXT"),
    (i.NEXT_BUTTON = "NEXT_BUTTON"),
    (i.BACK_BUTTON = "BACK_BUTTON"),
    (i.SUBMIT_BUTTON = "SUBMIT_BUTTON"),
    (i.DIVIDER = "DIVIDER"),
    (i.TEXT = "TEXT"),
    (i.EMAIL = "EMAIL"),
    (i.PASSWORD = "PASSWORD"),
  ...
  at = ((i) => ((i.BLOCK = "BLOCK"), (i.FIELD = "FIELD"), i))(at || {});
const Ce = e.object({
    id: e.string(),
    category: e.nativeEnum(at),
    type: e.nativeEnum(rt),
  }),
  Un = Ce.extend({
  ...
  Pn = e
    .object({ id: e.string(), category: e.string(), type: e.string() })
    .passthrough(),
  Hn = e.union([Un, Fn, Mn, Zn, Pn]),
  Vn = e.object({
    id: e.string(),
    type: e.literal("STEP"),
    coordinates: ge,
    ...
    config: e
      .object({ components: e.array(Hn), next_node: e.string() })
      .passthrough(),
  }),
  zn = e.object({
    id: e.string(),
    ...
    coordinates: ge,
    alias: e.string().optional(),
    config: e.object({ flow_id: e.string(), next_node: e.string() }),
  }),
  Gn = e
    .object({ id: e.string(), type: e.string(), coordinates: ge })
    .passthrough(),
  Bn = e.union([Vn, zn, Gn]),
  $n = e.object({ next_node: e.string(), coordinates: ge }).passthrough(),
  Wn = e
    .object({ resume_flow: e.boolean().optional(), coordinates: ge })
    .passthrough(),
  Kn = e
    .object({
      id: e.string(),
    ...
    .passthrough();
Kn.omit({ id: !0, created_at: !0, updated_at: !0 });
var st = ((i) => (
    (i.TOKEN = "token"),
    (i.TOKEN_ID_TOKEN = "token id_token"),
    (i.CODE = "code"),
    i
  ))(st || {}),
  ot = ((i) => (
    (i.QUERY = "query"),
    (i.FRAGMENT = "fragment"),
    (i.FORM_POST = "form_post"),
    (i.WEB_MESSAGE = "web_message"),
    (i.SAML_POST = "saml_post"),
    i
  ))(ot || {}),
  dt = ((i) => ((i.S256 = "S256"), (i.Plain = "plain"), i))(dt || {});
const Xn = e.object({
  client_id: e.string(),
  act_as: e.string().optional(),
  response_type: e.nativeEnum(st).optional(),
  response_mode: e.nativeEnum(ot).optional(),
  ...
  code_challenge_method: e.nativeEnum(dt).optional(),
...
e.object({
  ...
  font: e.object({ url: e.string() }).optional(),
});
const qn = e.object({
  ...
  Jn = e
    .object({
      id: e.string(),
      created_at: e.string().transform((i) => (i === null ? "" : i)),
      updated_at: e.string().transform((i) => (i === null ? "" : i)),
    })
    .extend(Yn.shape),
  Qn = e.object({
    name: e.string(),
...
e.object({ ...jn.shape, tenant: ei, connections: e.array(Jn) });
const ti = e.enum([
    "password_reset",
    "email_verification",
    "otp",
  ...
  ni = e.object({
    ...
    connection_id: e
      .string()
      .optional()
      .openapi({ description: "The connection that the code is connected to" }),
    code_type: ti,
    ...
    redirect_uri: e
      .string()
      .optional()
      .openapi({ description: "The redirect URI associated with the code" }),
    ...
    state: e.string().optional().openapi({
      description:
        "The state parameter used for CSRF protection in OAuth flows",
    }),
    expires_at: e.string(),
    used_at: e.string().optional(),
    user_id: e.string().optional(),
  });
e.object({ ...ni.shape, created_at: e.string() });
const ii = e.object({
    domain: e.string(),
  ...
  ai = e.object({
    ...
    verification: e.object({ methods: e.array(ri) }).optional(),
    tls_policy: e.string().optional(),
  });
ai.extend({ tenant_id: e.string() });
e.object({
  id: e.string(),
...
const si = e.discriminatedUnion("type", [
    e.object({
      id: e.string(),
      type: e.literal("RICH_TEXT"),
      config: e.object({ content: e.string() }),
      order: e.number().optional(),
      visible: e.boolean().optional().default(!0),
    }),
    e.object({
      id: e.string(),
      type: e.literal("LEGAL"),
      config: e.object({ text: e.string(), html: e.boolean().optional() }),
      required: e.boolean().optional(),
      order: e.number().optional(),
      visible: e.boolean().optional().default(!0),
    }),
  ...
  oi = e
    .object({
      ...
      start: e
        .object({
          hidden_fields: e
            .array(e.object({ key: e.string(), value: e.string() }))
            .optional(),
...
e.object({ ...J.shape, ...oi.shape, id: e.string() });
const ct = e.enum([
    "pre-user-signup",
    "post-user-registration",
    "post-user-login",
  ]),
  lt = e.enum(["pre-user-signup", "post-user-registration", "post-user-login"]),
  Oe = {
  ...
  di = e.object({ ...Oe, trigger_id: ct, url: e.string() }),
  ci = e.object({ ...Oe, trigger_id: lt, form_id: e.string() });
e.union([di, ci]);
const li = e.object({
    ...Oe,
    trigger_id: ct,
...
const fi = {
  ...
  hi = e.string().refine((i) => Object.values(fi).includes(i), {
...
e.object({ ...mi.shape, created_at: e.string(), updated_at: e.string() });
const ut = e.object({
    initial_user_agent: e
      .string()
      .describe(
  ...
  yi = e.object({
    ...
    device: ut.describe("Metadata related to the device used in the session"),
    clients: e
      .array(e.string())
...
e.object({
  ...
  pkcs7: e
    .string()
    .optional()
    .openapi({ description: "The private key in pkcs7 format" }),
  current: e
    .boolean()
    .optional()
...
e.object({ code: e.string(), state: e.string().optional() });
const vi = e.object({
  ...
  B = e.object({ bold: e.boolean(), size: e.number() }),
  Ei = e.object({
    body_text: B,
    buttons_text: B,
    font_url: e.string(),
...
e.object({
  ...
  credentials: e.union([
    ...
    e.object({ api_key: e.string(), domain: e.string().optional() }),
    e.object({ connectionString: e.string() }),
    e.object({
      tenantId: e.string(),
      clientId: e.string(),
...
const Ci = e.object({
  ...
  resource_servers: e.array(
    e.object({ audience: e.string(), scopes: e.string() }),
  ),
  rotating: e.boolean(),
});
e.object({ created_at: e.string(), ...Ci.shape });
e.object({ to: e.string(), message: e.string() });
e.object({ name: e.string(), options: e.object({}) });
const Oi = e.object({ value: e.string(), description: e.string().optional() }),
  ki = e.object({
...
const Mi = e.object({
    ...
    description: e
      ...
      .max(255)
      .optional()
      .openapi({ description: "The description of the role" }),
  }),
  Zi = e.object({
    id: e
      .string()
      .openapi({ description: "The unique identifier of the role" }),
    ...Mi.shape,
    created_at: e.string().optional(),
    updated_at: e.string().optional(),
  });
...
const Pi = e
    .object({
      logo_url: e
        .string()
        .optional()
        .openapi({ description: "URL of the organization's logo" }),
      colors: e
        .object({
  ...
  Vi = e
    .object({
      client_credentials: e
        .object({
          enforce: e
            .boolean()
            .default(!1)
            .openapi({ description: "Whether to enforce token quota limits" }),
          per_day: e
            .number()
            .min(0)
            .default(0)
            .openapi({ description: "Maximum tokens per day (0 = unlimited)" }),
  ...
  zi = e.object({
    ...
    display_name: e
      .string()
      .optional()
      .openapi({ description: "The display name of the organization" }),
    branding: Pi,
    metadata: e
      .record(e.any())
      .default({})
      .optional()
      .openapi({ description: "Custom metadata for the organization" }),
    enabled_connections: e.array(Hi).default([]).optional().openapi({
      description: "List of enabled connections for the organization",
    }),
    token_quota: Vi,
  });
e.object({ ...zi.shape, ...J.shape, id: e.string() });
const Gi = e.object({
...
e.object({ ...Gi.shape, ...J.shape, id: e.string() });
export { st as d, e as z };
