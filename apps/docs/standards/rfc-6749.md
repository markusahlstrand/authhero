...
- **Token revocation** (RFC 7009) — `POST /oauth/revoke`, advertised as `revocation_endpoint` in discovery. Revokes refresh tokens; see [RFC 7009](/standards/rfc-7009) for what is and isn't revocable.
