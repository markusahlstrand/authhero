...
- [Adapter Interfaces](/customization/adapter-interfaces/) - Standard adapter contracts
- [Writing Custom Adapters](/architecture/adapters) - Guide to creating adapters
- [Kysely Adapter](/customization/kysely/) - SQL alternative with full query support
