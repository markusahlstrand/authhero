...
- `oidcc-formpost-hybrid-certification-test-plan` ([oidcc-form-post-hybrid.spec.ts](tests/oidcc-form-post-hybrid.spec.ts)) — hybrid profile with `response_mode=form_post`; `response_type` pinned per-module by the plan
