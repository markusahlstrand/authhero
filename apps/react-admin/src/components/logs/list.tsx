...
const typeChoices = [
  ...
  { id: LogTypes.SUCCESS_EXCHANGE_REFRESH_TOKEN_FOR_ACCESS_TOKEN, name: "Success Refresh Token Exchange" },
  { id: LogTypes.FAILED_EXCHANGE_REFRESH_TOKEN_FOR_ACCESS_TOKEN, name: "Failed Refresh Token Exchange" },
  { id: LogTypes.FAILED_EXCHANGE_ROTATING_REFRESH_TOKEN, name: "Failed Rotating Refresh Token Exchange" },
  { id: LogTypes.SUCCESS_EXCHANGE_PASSWORD_FOR_ACCESS_TOKEN, name: "Success Password Exchange" },
  { id: LogTypes.FAILED_EXCHANGE_PASSWORD_FOR_ACCESS_TOKEN, name: "Failed Password Exchange" },
  ...
  { id: LogTypes.SUCCESS_CHANGE_PASSWORD_REQUEST, name: "Success Change Password Request" },
  { id: LogTypes.FAILED_CHANGE_PASSWORD_REQUEST, name: "Failed Change Password Request" },
  { id: LogTypes.SUCCESS_VERIFICATION_EMAIL, name: "Success Verification Email" },
  { id: LogTypes.FAILED_VERIFICATION_EMAIL, name: "Failed Verification Email" },
  { id: LogTypes.SUCCESS_VERIFICATION_EMAIL_REQUEST, name: "Success Verification Email Request" },
  { id: LogTypes.FAILED_VERIFICATION_EMAIL_REQUEST, name: "Failed Verification Email Request" },
