...
export const NodeEditor: React.FC<NodeEditorProps> = ({
  ...
  const [addComponentAnchor, setAddComponentAnchor] = useState<null | HTMLElement>(null);
  ...
  const handleMoveComponent = useCallback((index: number, direction: "up" | "down") => {
    setFormData((prev: any) => {
  ...
  const handleDeleteComponent = useCallback((componentId: string) => {
    setFormData((prev: any) => ({
      ...prev,
      components: (prev.components || []).filter((c: ComponentConfig) => c.id !== componentId),
    }));
  }, []);
  ...
  const renderStepNodeEditor = () => (
    <Box>
      ...
      {formData.components && formData.components.length > 0 ? (
        <Box sx={{ mt: 2 }}>
          {formData.components.map((component: ComponentConfig, index: number) => (
                ...
                {component.type === "RICH_TEXT" && component.config?.content
                  ...
                  : component.type === "LEGAL" && component.config?.text
                    ...
                    : component.type === "NEXT_BUTTON" && component.config?.text
                      ...
                      : (component.type === "TEXT" || component.type === "EMAIL" || component.type === "NUMBER" || component.type === "PHONE") && component.config?.label
  ...
  return (
    ...
    >
      <DialogTitle>
        Edit {editingComponent?.type} Component
      </DialogTitle>
      <DialogContent>
        {editingComponent?.type === "RICH_TEXT" && (
          <Box sx={{ mt: 2 }}>
            ...
            <RichTextEditor
              ...
              onChange={(value) => handleComponentFieldChange("content", value)}
            />
        ...
        {editingComponent?.type === "LEGAL" && (
          <TextField
            ...
            onChange={(e) => handleComponentFieldChange("text", e.target.value)}
            margin="normal"
            multiline
            rows={3}
        ...
        {(editingComponent?.type === "TEXT" ||
          ...
          <Box>
            <TextField
              ...
              onChange={(e) => handleComponentFieldChange("label", e.target.value)}
              margin="normal"
            ...
            <TextField
              ...
              onChange={(e) => handleComponentFieldChange("placeholder", e.target.value)}
              margin="normal"
