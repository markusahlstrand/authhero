CREATE TABLE `tenants` (
	...
	`deployment_type` text(16) DEFAULT 'shared' NOT NULL,
	`provisioning_state` text(16) DEFAULT 'ready' NOT NULL,
...
CREATE TABLE `clients` (
	...
	`hide_sign_up_disabled_error` integer DEFAULT 0 NOT NULL,
...
CREATE INDEX `idx_outbox_events_tenant_dead_lettered` ON `outbox_events` (`tenant_id`,`dead_lettered_at`);--> statement-breakpoint
CREATE TABLE `proxy_routes` (
	...
	`match` text(2048) DEFAULT '{"path":"/*"}' NOT NULL,
	`handlers` text(16384) DEFAULT '[]' NOT NULL,
	`created_at` text(35) NOT NULL,
	`updated_at` text(35) NOT NULL
);
--> statement-breakpoint
