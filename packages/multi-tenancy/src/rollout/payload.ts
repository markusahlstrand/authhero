 ...
 * keys, which only flow through the payload (build + apply), never through the
 * in-process `projectControlPlaneDefaults`.
 */
...
/** Result of applying a payload — the projection result plus the key outcome. */
