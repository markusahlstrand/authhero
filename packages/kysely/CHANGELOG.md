...
- f6c4e9a: `organizations.remove` now reports whether a row was actually deleted. It
...
- 0a6d311: Make the refresh_tokens session_id backfill size-aware, and add a bulk SQL path.
...
- d27d72a: Squash the migration set into a production-derived baseline
