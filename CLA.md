# AuthHero Individual Contributor License Agreement

Thank you for your interest in contributing to AuthHero ("the Project"), maintained by
**Markus Ahlstrand** ("the Maintainer").

This Contributor License Agreement ("Agreement") documents the rights granted by
contributors to the Maintainer. This is a legally binding document, so please read it
carefully before agreeing. By commenting `I have read the CLA Document and I hereby sign
the CLA` on a pull request (or otherwise signing as instructed by the CLA bot), You
accept and agree to these terms for Your present and future Contributions submitted to
the Project.
...
- **"Contribution"** means any work of authorship, including any modifications or
  additions to an existing work, that You intentionally submit to the Project in any
  form (source code, documentation, configuration, or otherwise).
...
**under any license terms, including without limitation the GNU AGPL-3.0 and
proprietary/commercial license terms**. This relicensing right is what enables the
Project's dual-licensing model.
...
sell, sell, import, and otherwise transfer Your Contribution, where such license applies
only to those patent claims licensable by You that are necessarily infringed by Your
Contribution alone or by combination of Your Contribution with the Project. If any
...
this Agreement for that Contribution or Project shall terminate as of the date such
litigation is filed.
...
1. You are legally entitled to grant the above licenses. If Your employer has rights to
...
grants licenses; it is not an assignment. Nothing in this Agreement limits Your right to
use, license, or distribute Your own Contributions for any other purpose.
